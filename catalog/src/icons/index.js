...
/** Data table / sheet (header row + columns) */
...
/** 2×2 app launcher — outlined to match other header icons (stroke weight, no fill seams). */
...
const DATA_PRODUCT_TYPES_LOWER = new Set(['data product']);
