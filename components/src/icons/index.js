...
import ecosystemCatalogLotusSvg from './ecosystem-catalog-lotus.svg';
import ecosystemLogo3Png from './logo3.png';
import ecosystemLogo4Png from './logo4.png';
import ecosystemLogo5Png from './logo5.png';
import ecosystemLogo6Png from './logo6.png';
import ecosystemLogo7Png from './logo7.png';
import ecosystemLogo7DarkPng from './logo7-dark.png';
import ecosystemLogo8Png from './logo8.png';
...
export function ApiLogoIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden className="ecosystemAppLogoSvg">
      <path d="M10 10l-4 6 4 6M22 10l4 6-4 6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18.5 8l-5 16" strokeLinecap="round" />
    </svg>
  );
}
...
/** Ecosystem launcher — lotus mark (catalog hero branding; shared SVG asset) */
export function EcosystemCatalogLogoIcon() {
  return <img src={ecosystemCatalogLotusSvg} alt="" aria-hidden className="ecosystemAppLogoImg" />;
}

export function EcosystemLogo3Icon() {
  return <img src={ecosystemLogo3Png} alt="" aria-hidden className="ecosystemAppLogoImg" />;
}

export function EcosystemLogo4Icon() {
  return <img src={ecosystemLogo4Png} alt="" aria-hidden className="ecosystemAppLogoImg" />;
}

export function EcosystemLogo5Icon() {
  return <img src={ecosystemLogo5Png} alt="" aria-hidden className="ecosystemAppLogoImg" />;
}

/** Catalog app row in the header “more apps” menu only (hero branding may still use lotus). */
export function EcosystemLogo6Icon() {
  return <img src={ecosystemLogo6Png} alt="" aria-hidden className="ecosystemAppLogoImg" />;
}

export function EcosystemLogo7Icon() {
  return (
    <>
      <img
        src={ecosystemLogo7Png}
        alt=""
        aria-hidden
        className="ecosystemAppLogoImg ecosystemLogo7Img ecosystemLogo7Img--light"
      />
      <img
        src={ecosystemLogo7DarkPng}
        alt=""
        aria-hidden
        className="ecosystemAppLogoImg ecosystemLogo7Img ecosystemLogo7Img--dark"
      />
    </>
  );
}

export function EcosystemLogo8Icon() {
  return <img src={ecosystemLogo8Png} alt="" aria-hidden className="ecosystemAppLogoImg" />;
}

/** Flow / modeler glyph used for Actions menu trigger (reference asset role) */
export function FlowModelerGlyph({ size = 18 }) {
  return (
    <svg
      className="flowModelerGlyph"
      viewBox="0 0 24 24"
      width={size}
      height={size}
      fill="none"
...
/** Line van / delivery truck — Actions menu “Register a Data Tool” */
export function DeliveryVanIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M1 4h11v11H1zM12 8h3l4 4v3h-7V8z" />
